# -*- coding: utf-8 -*-
"""multiscalesampler.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1TrNby84RNTuGqI5FuCq1xZC9H_UeCPnd
"""
...
class MultiScaleSamplerDDP(BatchSampler):
    def __init__(self,
                 base_image_width=192,
                 base_image_height=256,
                 base_batch_size=1,
                 min_scale_multi=0.5,
                 max_scale_multi=1.5,
                 num_scales=5,
        ...
        local_num_samples = int(math.ceil(num_replicas / world_size))
        total_size = local_num_samples * world_size
        image_indices = [idx for idx in range(num_replicas)]
        image_indices += image_indices[:(total_size - num_replicas)]
