...
Original file is located at
    https://colab.research.google.com/drive/1yh8d_Fa-DbC-A-Pgdu4-VjkjLn1t8bBV
"""
...
class MobileViT(nn.Module):
    def __init__(self, img_size, features_list, d_list, transformer_depth, expansion, num_classes = 80):
